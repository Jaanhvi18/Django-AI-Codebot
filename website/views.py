...
def home(request):
    lang_list = ['c', 'cfscript', 'clike', 'coffeescript', 'cpp', 'csharp', 'css', 'csv', 'dart', 'django', 'erlang', 'excel-formula', 'fortran', 'go', 'java', 'javascript', 'json', 'jsx', 'julia', 'kotlin', 'latex', 'markup',
                 'markup-templating', 'matlab', 'mongodb', 'objectivec', 'pascal', 'perl', 'php', 'plsql', 'powershell', 'python', 'r', 'regex', 'rest', 'ruby', 'rust', 'sass', 'sql', 'swift', 'tsx', 'typescript', 'yaml', 'yang']
    ...
    if request.method == "POST":
        ...
        if lang == "Select Programming Language":
            ...
            # OpenAI Key
            openai.api_key = "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"
